...
1. `C:\Users\Lg\OneDrive\文件\Obsidian Vault\README.md` — 專案狀態總覽
2. `C:\Users\Lg\OneDrive\文件\Obsidian Vault\Daily\` — 最近一份 Daily log（昨天或今天）
3. `C:\Users\Lg\OneDrive\文件\Obsidian Vault\踩坑記錄\API 踩坑.md` — 歷史踩坑記錄
